...
function Vr(t2) {
  return Pr(t2) || vr(t2) || function(t3) {
...
function Dr(t2, e) {
  let n;
  return M2(t2 instanceof Re || t2 instanceof be), M2(e instanceof Re || e instanceof be), n = t2 instanceof Re ? e instanceof Re ? function(t3, e2) {
    return be.create([t3, e2], "and");
...
function xr(t2) {
  ...
  return n.forEach((e2) => {
    e2 instanceof Re ? s.push(e2) : e2 instanceof be && (e2.op === t2.op ? s.push(...e2.filters) : s.push(e2));
...
var Mr = class {
  constructor(t2, e) {
    this.user = t2, this.databaseId = e, this.Ye = new kr(), this.Xe = new ls((t3) => nn(t3), (t3, e2) => sn(t3, e2)), this.uid = t2.uid || "";
  }
  addToCollectionParentIndex(t2, e) {
    if (!this.Ye.has(e)) {
  ...
  Ze(t2) {
    ...
    if (0 === t2.filters.length)
      ...
      e = br(be.create(t2.filters, "and")).map((e2) => en(t2.path, t2.collectionGroup, t2.orderBy, e2.getFilters(), t2.limit, t2.startAt, t2.endAt));
    }
  ...
  rn(t2) {
    const e = new pr();
    return dr.Ie.ue(t2, e.qe(0)), e.Fe();
  }
  an(t2, e) {
    const n = new pr();
...
var jr = class {
  constructor(t2, e, n, s) {
    this.userId = t2, this.yt = e, this.indexManager = n, this.referenceDelegate = s, this.In = {};
  }
  static re(t2, e, n, s) {
    M2("" !== t2.uid);
...
var oo = class {
  ...
  Kn(t2, e) {
    ...
    return n.Z({
      ...
      0 === t3 ? (i !== Ot.at && e(new ct(pi(s)), i), i = o, s = r) : i = Ot.at;
    }).next(() => {
...
var ao = class {
  ...
  zn(t2, e, n) {
    ...
    return _o(t2).Z({
      ...
      o && o.isEqual(i2) && (n(o, e2), o = r.hasNext() ? r.getNext() : null), o ? s2.j(wo(o)) : s2.done();
    }).next(() => {
      for (; o; )
...
var lo = class extends co {
  constructor(t2, e) {
    super(), this.Yn = t2, this.trackRemovals = e, this.Xn = new ls((t3) => t3.toString(), (t3, e2) => t3.isEqual(e2));
  }
  applyChanges(t2) {
    const e = [];
  ...
  getDocumentsMatchingCollectionQuery(t2, e, n) {
    ...
    return this.remoteDocumentCache.getAllFromCollection(t2, e.path, n).next((i) => (s = i, this.documentOverlayCache.getOverlaysForCollection(t2, e.path, n.largestBatchId))).next((t3) => {
      ...
      return s.forEach((s2, i) => {
        const r = t3.get(s2);
        void 0 !== r && Jn(r.mutation, i, Je.empty(), nt.now()), An(e, i) && (n2 = n2.insert(s2, i));
      }), n2;
    });
  }
};
...
var hu = class {
  constructor(t2, e, n, s, i) {
    this.window = t2, this.Hs = e, this.persistenceKey = n, this.sr = s, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.ir = this.rr.bind(this), this.ur = new Ge(Z), this.started = false, this.cr = [];
    const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.ar = nu(this.persistenceKey, this.sr), this.hr = function(t3) {
      return `firestore_sequence_number_${t3}`;
    }(this.persistenceKey), this.ur = this.ur.insert(this.sr, new au()), this.lr = new RegExp(`^firestore_clients_${r}_([^_]*)$`), this.dr = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`), this._r = new RegExp(`^firestore_targets_${r}_(\\d+)$`), this.wr = function(t3) {
...
var gc2 = class {
  constructor(t2, e, n) {
    this.Mu = t2, this.localStore = e, this.yt = n, this.queries = [], this.documents = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = yc2(t2);
  }
  Fu(t2) {
...
async function Wc2(t2, e, n, s) {
  ...
  null !== r ? ("pending" === n ? await Ku(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (Mc2(i, e, s || null), Oc2(i, e), function(t3, e2) {
    $($(t3).mutationQueue).An(e2);
  }(i.localStore, e)) : O2(), await Uc2(i, r)) : C2("SyncEngine", "Cannot apply mutation batch with id: " + e);
}
async function zc2(t2, e) {
  ...
  if (ta2(n), ea2(n), true === e && true !== n.dc) {
    ...
    }), await e2, await Hc2(n, t3), function(t4) {
      const e3 = $(t4);
      e3.cc.forEach((t5, n2) => {
...
var ia2 = class extends sa2 {
  ...
  async initialize(t2) {
    await super.initialize(t2), await this.Ac.initialize(this, t2), await ea2(this.Ac.syncEngine), await Ku(this.Ac.remoteStore), await this.persistence.li(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  Ic(t2) {
    return qo(this.persistence, new Bo(), t2.initialUser, this.yt);
  }
...
var oa2 = class {
  async initialize(t2, e) {
    this.localStore || (this.localStore = t2.localStore, this.sharedClientState = t2.sharedClientState, this.datastore = this.createDatastore(e), this.remoteStore = this.createRemoteStore(e), this.eventManager = this.createEventManager(e), this.syncEngine = this.createSyncEngine(
      e,
      !t2.synchronizeTabs
    ), this.sharedClientState.onlineStateHandler = (t3) => Dc2(this.syncEngine, t3, 1), this.remoteStore.remoteSyncer.handleCredentialChange = Kc2.bind(null, this.syncEngine), await Zu(this.remoteStore, this.syncEngine.isPrimaryClient));
  }
...
function Aa2(t2, e, ...n) {
  if (t2 = getModularInstance(t2), 1 === arguments.length && (e = X2.R()), ua2("doc", "path", e), t2 instanceof ma2) {
    const s = rt.fromString(e, ...n);
...
var Va2 = class {
  constructor(t2, e) {
    this.Pc = t2, this.yt = e, this.metadata = new q2(), this.buffer = new Uint8Array(), this.vc = new TextDecoder("utf-8"), this.Vc().then((t3) => {
...
var Na2 = class {
  constructor(t2, e, n, s, i) {
    this.asyncQueue = t2, this.datastore = e, this.options = n, this.updateFunction = s, this.deferred = i, this.kc = n.maxAttempts, this.xo = new Iu(this.asyncQueue, "transaction_retry");
  }
  run() {
    this.kc -= 1, this.Oc();
  }
...
function ja2(t2) {
  return t2.asyncQueue.enqueue(async () => {
    ...
    return e.setNetworkEnabled(false), async function(t3) {
      const e2 = $(t3);
      e2._u.add(0), await Su(e2), e2.gu.set("Offline");
    }(n);
  });
}
function Wa2(t2, e) {
...
function fl(t2) {
  return da2("limit", t2), ll._create("limit", t2, "F");
}
function dl(t2) {
  return da2("limitToLast", t2), ll._create("limitToLast", t2, "L");
}
...
//# sourceMappingURL=chunk-BW2ZITGG.js.map
